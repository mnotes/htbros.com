...
?>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
				    ...
				    <a class="tip-right preview" title="<?php echo trans('Preview')?>" data-url="<?php echo $current_path.$rfm_subfolder.$subdir.$file;?>" data-toggle="lightbox" href="#previewLightbox"><i class=" icon-eye-open"></i></a>
